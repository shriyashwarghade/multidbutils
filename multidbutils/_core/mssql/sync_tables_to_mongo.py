...
from multidbutils._core.functions.msql_functions import convert_sql_data_to_python, get_table_schema, check_table_names


def sync_tables_to_mongo(sql_connection_cursor, mongo_connection_cursor, source_tables_list, failure_rollback,
                         flush_old_data):
    ...
    if tables_not_found: raise Exception(f"{','.join(tables_not_found)} Table(s) Not Found in MSSQL Database.")
